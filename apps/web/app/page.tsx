...
const PRICING = [
  {
    ...
    price: '$0',
    period: 'forever',
    desc: 'Full detection power with no commitment.',
    features: [
      'Regex + ML detection (all guardrails)',
      'PII redaction (16 patterns + NER)',
      'Prompt injection (regex + semantic ML)',
      'Jailbreak detection',
      'Content filtering + ML toxicity',
      'Cost guard',
      'Unicode sanitizer & secret detection',
      '1,000 events / mo',
      'Security dashboard (7-day retention)',
    ],
    cta: 'Start Free Beta',
    highlighted: false,
  },
  {
    ...
    price: '$29',
    period: '/ month',
    desc: 'For solo developers shipping secure LLM apps.',
    features: [
      'Everything in Free',
      'Streaming guard (mid-stream scanning)',
