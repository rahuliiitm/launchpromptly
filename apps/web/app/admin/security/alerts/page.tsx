      ...
      <div className="mt-6 space-y-4">
        {rules.length === 0 && !showCreateForm && (
          <div className="rounded-lg border bg-white p-12 text-center">
            ...
            <h2 className="mt-4 text-lg font-semibold text-gray-700">No alert rules configured</h2>
            <p className="mt-2 max-w-md mx-auto text-sm text-gray-500">
              Get notified when PII is detected, injections are blocked, or cost limits are hit. Alerts can fire via webhook, email, or Slack.
            </p>
          </div>
        )}
